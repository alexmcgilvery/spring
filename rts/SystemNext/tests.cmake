...
add_spring_test(RuntimeCoordinator
	"${runtime_test_dir}/testApplicationLoop.cpp;${runtime_dir}/ApplicationLoop.cpp;${runtime_dir}/Session/SessionUpdate.cpp;${runtime_dir}/Presentation/SerialVisualFrame.cpp;${runtime_dir}/Diagnostics/LoopPhaseScope.cpp;${test_Catch_main}"
	"" "${runtime_flags}")
...
add_spring_test(RuntimeFileSink
	"${runtime_test_dir}/Diagnostics/testLegacyFileSink.cpp;${CMAKE_SOURCE_DIR}/rts/System/Log/FileSink.cpp;${test_Common_sources}"
